    ...
    <AuthenticatedLayout title="Dashboard">
            ...
            <div class="grid gid-cols-2 md:grid-cols-2 gap-3">
                <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
                    ...
                    <div class="mt-5 flex justify-center">
                        ...
                        <span
                            class="bg-gray-100 text-gray-800 text-xs font-semibold mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">SEM OPERAR</span>
                    </div>
                </div>
                    ...
                    <div class="flex-auto p-4">
                        <div class="flex flex-row -mx-3">
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    <h5 class="mb-2 text-md font-semibold leading-tight text-gray-900 dark:text-white uppercase">
                                        Banca inicial</h5>
                            ...
                            <div class="flex-none w-2/3 max-w-full px-3">
                                <div>
                                    ...
                                    <div class="flex gap-2">
                                        ...
                                        <span v-show="true" class="text-sm font-bold leading-normal text-emerald-500">+55% </span>
                                        <span v-show="false"
                                              class="text-sm font-bold leading-normal text-red-500">-55% </span>
                                    </div>
        ...
        <div class=" mt-10 grid grid-cols-1 md:grid-cols-2 gap-3">
            <div class="w-full p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
                ...
                <div class="mt-5 w-full flex items-center justify-center">
                    <apexchart id="barChart" type="bar" width="450px" :options="barOptionsYear"
                               :series="barSeriesYear"></apexchart>
                </div>
            </div>
            <div class="w-full p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
                <div class="mb-5">
                ...
                <div class="mt-5 w-full flex items-center justify-center">
                    <apexchart id="barChart" type="bar" width="450px" :options="barOptions"
                               :series="barSeries"></apexchart>
                </div>
            </div>
        </div>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <span class="text-sm font-bold leading-normal text-black dark:text-gray-400">04/12/2022</span>
                    </th>
                    <th scope="row" class="py-4 px-6 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    <td class="py-4 px-6">
                        <div class="flex gap-2">
                            <span v-show="true"
                                  class="text-sm font-bold leading-normal text-emerald-500">+ R$ 30,00 </span>
                            <span v-show="false"
        ...
        <Modal size="7xl" v-if="isShowModal">
            ...
            <template #body>
                ...
                <div v-if="true" class=" grid grid-cols-1 md:grid-cols-2 gap-3">
                                ...
                                <the-card href="#" class="w-full">
                                    <div class="flex-auto p-4">
                                        <div class="flex flex-row -mx-3">
                                            <div class="flex-none w-2/3 max-w-full px-3">
                                                <div>
                                                    <h5 class="mb-2 text-1xl font-semibold leading-tight text-gray-900 dark:text-white uppercase">
                                                        Take Profit</h5>
                                        ...
                                        <div class="mt-6 w-full">
                                            <Progress :labelProgress="true" labelPosition="outside" size="xl"
                                                      color="green"
                                                      label=""
                                ...
                                <the-card href="#" class="w-full">
                                    <div class="flex-auto p-4">
                                        <div class="flex flex-row -mx-3">
                                            ...
                                            <div class="px-3 text-right basis-1/3">
                                                <div
                                                    class="inline-block w-12 h-12 text-center rounded-md bg-cyan-500">
                                                    <i class="ni leading-none ni-money-coins text-lg relative top-3.5 text-white"></i>
                                                    <font-awesome-icon
                                                        class="ni leading-none ni-money-coins text-lg relative top-3.5 text-white"
                                                        icon="fa-solid fa-bullseye"/>
                                    ...
                                    <div class="">
                                        <Progress :labelProgress="true" labelPosition="outside" size="xl" color="yellow"
                                                  label="Em risco"
                    ...
                    <the-card href="#" variant="horizontal" class="w-full">
                        <div class="p-6 overflow-hidden bg-white rounded-md shadow-md dark:bg-dark-eval-1">
