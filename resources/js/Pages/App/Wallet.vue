...
import { CheckIcon, EyeIcon, AcademicCapIcon, MinusCircleIcon, PlusCircleIcon, ArrowCircleRightIcon, PresentationChartLineIcon, CalendarIcon, TrashIcon } from "@heroicons/vue/outline";
